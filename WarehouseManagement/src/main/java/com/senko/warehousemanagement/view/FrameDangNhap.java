...
import com.senko.warehousemanagement.view.form.PasswordResetAuthForm;
...
public class FrameDangNhap extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        NhanVien currentUser = controller.kiemTraDangNhap(jTextField1.getText(), jPasswordField1.getPassword());
        if(currentUser != null){
            new Main(currentUser).setVisible(true);
            dispose();
        }
        else{
            JOptionPane.showConfirmDialog(this,"Nhập lại đi đại ca","Thông báo", JOptionPane.PLAIN_MESSAGE);
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        PasswordResetAuthForm form = new PasswordResetAuthForm(this, true);
